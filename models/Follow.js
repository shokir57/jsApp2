    ...
    return new Promise(async (resolve, reject) => {
        try {
            let followers = await followsCollection.aggregate([
                ...
                // spell out what should be displayed in the returned object
                {$project: {  
            ...
            followers = followers.map(function(follower) {
                ...
                return {username: follower.username, avatar: user.avatar}  // 2 pieces of data to show on the front end of our website
            })
            resolve(followers)
        } catch {
            reject()
